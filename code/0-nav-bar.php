            ...
            <div class='container'>
                ...
                <div class='collapse navbar-collapse justify-content-center' id='navbarNav'>
                    <ul class='navbar-nav w-100 d-flex flex-column flex-lg-row align-items-center'>
                        ...
                        <li class='nav-item'><a class='nav-link' href='#events' id='nav-events'>Shows</a></li>
                        ...
                        <li class='nav-item'>
                            <a class='nav-link' href='https://open.spotify.com/artist/6o0z83KmtPJtdpUFwJKhEj'
                               id='nav-spotify' target='_blank' rel='noopener noreferrer'>
