...
$_nav= "
    <header>
        <nav id='navbar' class='bm-navbar'>
            <div class='bm-nav-inner'>

                <!-- Logo + Nombre — siempre visible en desktop -->
                <a href='#home' class='bm-brand' id='bm-brand'>
                    <img src='../img/blind_monkey_logo.jpg'
                         alt='Blind Monkey'
                         class='bm-brand-logo'
                         id='bm-brand-logo'>
                    <span class='bm-brand-name'>Blind<br>Monkey</span>
                </a>

                <!-- Links desktop -->
                <ul class='bm-nav-links' id='bm-nav-links'>
                    ...
                    <li>
                        <a class='bm-link bm-link-spotify'
                           href='https://open.spotify.com/artist/6o0z83KmtPJtdpUFwJKhEj'
            ...
            <!-- Mobile menu -->
            <div class='bm-mobile-menu' id='bm-mobile-menu'>
                <ul class='bm-mobile-links'>
