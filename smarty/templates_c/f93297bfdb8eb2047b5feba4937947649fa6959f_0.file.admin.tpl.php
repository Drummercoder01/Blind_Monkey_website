<?php
/* Smarty version 3.1.31, created on 2023-07-23 13:07:10
  from "/home/a102235/domains/donmateo.ziehoeveelmensenbetaalden1euro.com/public_html/smarty/templates/admin.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_64bd09dec20fe0_44891729',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f93297bfdb8eb2047b5feba4937947649fa6959f' => 
    array (
      0 => '/home/a102235/domains/donmateo.ziehoeveelmensenbetaalden1euro.com/public_html/smarty/templates/admin.tpl',
      1 => 1690110423,
      2 => 'file',
    ),
  ),
...
function content_64bd09dec20fe0_44891729 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="col-12 col-lg-3 d-none d-lg-block position-fixed pt-4 pb-4" id="sidebar">
            <ul class="navbar-nav flex-column w-100">
                <li class="nav-item text-center mb-5">
                    <a class="logoHeader" href="../scripts/admin_reservas.php">Don Mateo adminpanel</a>
				...
				<li class="nav-item">
                	<a class="nav-link" href="../scripts/admin_mensajes.php"><i class="fas fa-regular fa-envelope"></i>Mensajes</a>
            	</li>

				<li class="nav-item">
                	<a class="nav-link" href="../scripts/Z_uitloggen.php"><i class="fa fa-sign-out"></i>Salir</a>
            	</li>                
            </ul>
        </div>
        <div class="col-12 px-0">
            ...
            <div class="col-12 d-block d-lg-none px-0" class="navHolder" id="sidebarMobile">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="container">
                        <a class="navbar-brand" href="../scripts/admin_home.php">Don Mateo adminpanel</a>
